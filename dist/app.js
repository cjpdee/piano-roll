...
Vue__WEBPACK_IMPORTED_MODULE_1__["default"].component('Oscillator', {
  props: {
    isPlaying: false
  },
  data: function data() {
...
function initEventListeners() {
  ...
  var $newOscillatorBtn = document.querySelector("[data-js-project=new-oscillator]");
  $newOscillatorBtn.addEventListener('click', function () {
    var newOsc = new _objects_Oscillator__WEBPACK_IMPORTED_MODULE_1__["default"]();
    console.log(newOsc);
    _store__WEBPACK_IMPORTED_MODULE_0__["default"].addOscillator(newOsc);
  });
}
...
__webpack_require__(/*! /Users/Charlie/Code/piano-roll/src/js/app.js */"./src/js/app.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module '/Users/Charlie/Code/piano-roll/src/js/objects'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '/Users/Charlie/Code/piano-roll/src/js/session'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
